...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox2.setGeometry(QtCore.QRect(170,280,93,28))
        self.buttonBox2.addButton(self.Presets, QtWidgets.QDialogButtonBox.Action)
        self.buttonBox2.addButton(self.Update)
