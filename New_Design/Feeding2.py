...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(60, 40, 161, 41))
        font = QtGui.QFont()
        ...
        self.widget.setGeometry(QtCore.QRect(10, 280, 209, 30))
        self.widget.setObjectName("widget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.Presets = QtWidgets.QPushButton(self.widget)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setText(_translate("Dialog", "Update Schedule"))
